...
import { ServiceData_Page5 } from "../constant/ServicePageConstant"
...
gap-10">
            ...
            ref={service4TextRef}
            variant="heading"
            className="text-[#00144F]! font-Alex font-normal">{ServiceData_Page5.heading}</Typography>
          <Typography
            ref={service4TextRef}
          variant="longPara"
          className="text-[#00144F]!">
           {ServiceData_Page5.para}
          </Typography>
...
px-4 sm:px-8 py-4 max-sm:flex-col max-sm:gap-6">
           {ServiceData_Page5.boxes.map((item)=>{
            return(
               <div className="w-full sm:w-[31%] flex flex-col items-start justify-start gap-8">
              <img src={item.img} alt="" />
             <div className="flex flex-col items-start justify-between
             px-12 h-fit sm:h-72 max-sm:gap-4">
        ...
        className="w-full max-sm:py-10 sm:pb-20 sm:pt-40">
            <Banner variant="variantfive" dataKey="service5" 
          className="transform scale-100 sm:scale-110 origin-bottom 
          h-fit!"/>
        </div>
      </div>
    </Layout>
