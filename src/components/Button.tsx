...
const Button: React.FC<ButtonProps> = ({ variant = "yellowSolid", text, className, ...props }) => {
  const variantMap: Record<ButtonVariant, JSX.Element> = {
    yellowSolid: (
      <button
        className={`text-[#00144F] px-4 sm:px-5 py-3 sm:py-4 max-sm:justify-center rounded-full
        cursor-pointer bg-[#F5AF1B] font-lex font-bold sm:font-semibold text-sm
        border-none hover:bg-white shadow-2xl hover:-translate-y-1 
        hover:scale-105 transition ease-out duration-150 max-sm:w-fit max-sm:flex-wrap 
    ...
    whitePhone: (
      ...
      >
        {text}
        <span className="flex justify-start items-center gap-2 max-sm:hidden">
    ...
    bluephone: (
      <button
        className={`text-white/80 px-4 sm:px-5 py-2 sm:py-4 max-sm:justify-center rounded-full
    ...
    darkCalendar: (
      <button
        className="text-white/80 p-2 sm:p-1 pr-3 sm:pr-5 max-sm:justify-center rounded-full
      ...
      >
        <span
          className="gap-2 w-8 h-8 sm:w-12 sm:h-12 bg-[#F5AF1B]
          flex justify-center items-center max-sm:justify-center rounded-full p-2 sm:p-1"
        >
    ...
    yellowPhone: (
      <button
        className="text-[#00144F] p-1 pr-3 sm:pr-5 max-sm:justify-center rounded-full
      ...
      >
        <span
          ...
          flex justify-center items-center max-sm:justify-center rounded-full p-1"
        >
    ...
    darkPhone: (
      <button
        className="group text-white/80 px-4 sm:px-5 py-2 sm:py-4 max-sm:justify-center rounded-full
        cursor-pointer bg-[#00144F] font-lex font-semibold text-sm
